...
```
# 更新版本记录（追加新版本）
feishu_doc --action append --doc_token <文档ID> --content "## v1.0.3 (2026-02-16)\n\n更新内容..."
...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v1.0.3 | 2026-02-17 | 添加版本管理、自动递增版本号 |
| v1.0.3 | 2026-02-16 | 优化检验功能 |
| v1.0.3 | 2026-02-15 | 初始版本 |

---

_Last updated: 2026-02-17 11:30_
